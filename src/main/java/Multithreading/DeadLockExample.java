...
class Task1 implements Runnable {
    ...
    @Override
    public void run(){
        // this method clears deadlock what happens is
        // when your write sync(paper) it first waits till paper object is unlock and then it will lock paper
        //then call the inside functions
        synchronized (paper) {
